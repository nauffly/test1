var supabase;
// JAVI_BUILD: 2026-02-06-receipt-returned-gear
/**
...
async function renderDashboard(view){
  ...
  if(totalActiveOut===0){
    ...
    for(const e of ongoingEvents){
      ...
      c2.appendChild(el("a",{href:`#events/${e.id}`, class:"listItem"},[
        el("div",{class:"stack"},[
          el("div",{style:"font-weight:700"},[e.title]),
          el("div",{class:"kv"},[`Ongoing • ends ${fmt(e.end_at)}`]),
          el("div",{class:"kv"},[preview ? (preview + more) : `${rs.length} item(s)`])
        ]),
